...
@Generated(
    ...
    date = "2021-09-27T22:12:01.897440-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class AbsenceOfInformationEvaluation implements EntryEntity {
  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/Absence statement
  ...
  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/Tree/Absence statement/null_flavour
   */
  @Path("/data[at0001]/items[at0002]/null_flavour|defining_code")
  private NullFlavour absenceStatementNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/Last updated
  ...
  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/Tree/Last updated/null_flavour
   */
  @Path("/protocol[at0003]/items[at0004]/null_flavour|defining_code")
  private NullFlavour lastUpdatedNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/Extension
  ...
  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: International Patient Summary/Medication Summary/Absence of information/feeder_audit
   */
  @Path("/feeder_audit")
