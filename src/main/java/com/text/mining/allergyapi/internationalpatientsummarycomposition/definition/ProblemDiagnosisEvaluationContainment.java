...
public class ProblemDiagnosisEvaluationContainment extends Containment {
  ...
  public SelectAqlField<TemporalAccessor> DATE_OF_ABATEMENT_VALUE = new AqlFieldImp<TemporalAccessor>(ProblemDiagnosisEvaluation.class, "/data[at0001]/items[at0030]/value|value", "dateOfAbatementValue", TemporalAccessor.class, this);

  public SelectAqlField<NullFlavour> DATE_OF_ABATEMENT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(ProblemDiagnosisEvaluation.class, "/data[at0001]/items[at0030]/null_flavour|defining_code", "dateOfAbatementNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<ProblemDiagnosisQualifierCluster> PROBLEM_DIAGNOSIS_QUALIFIER = new AqlFieldImp<ProblemDiagnosisQualifierCluster>(ProblemDiagnosisEvaluation.class, "/data[at0001]/items[openEHR-EHR-CLUSTER.problem_qualifier.v1]", "problemDiagnosisQualifier", ProblemDiagnosisQualifierCluster.class, this);
