...
@Generated(
    ...
    date = "2021-09-27T22:12:01.927904-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ProblemDiagnosisEvaluation implements EntryEntity {
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Problem/Diagnosis name
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/structure/Problem/Diagnosis name/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Structured body site
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Date/time of onset
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/structure/Date/time of onset/null_flavour
   */
  @Path("/data[at0001]/items[at0077]/null_flavour|defining_code")
  private NullFlavour dateTimeOfOnsetNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/structure/Severity/null_flavour
   */
  @Path("/data[at0001]/items[at0005]/null_flavour|defining_code")
  private NullFlavour severityNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Specific details
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Date of abatement
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/structure/Date of abatement/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Problem/Diagnosis qualifier
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/structure/Diagnostic certainty/null_flavour
   */
  @Path("/data[at0001]/items[at0073]/null_flavour|defining_code")
  private NullFlavour diagnosticCertaintyNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Last updated
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Tree/Last updated/null_flavour
   */
  @Path("/protocol[at0032]/items[at0070]/null_flavour|defining_code")
  private NullFlavour lastUpdatedNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Extension
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/language
   */
  @Path("/language")
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Severity
  ...
  /**
   * Path: International Patient Summary/Problem List/Problem/Diagnosis/Diagnostic certainty
