...
@Generated(
    ...
    date = "2021-09-27T22:12:01.941533-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ExclusionGlobalEvaluation3 implements EntryEntity {
  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/Global exclusion of problems/diagnoses
  ...
  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/Tree/Global exclusion of problems/diagnoses/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/Extension
  ...
  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: International Patient Summary/Problem List/Exclusion - global/feeder_audit
   */
  @Path("/feeder_audit")
