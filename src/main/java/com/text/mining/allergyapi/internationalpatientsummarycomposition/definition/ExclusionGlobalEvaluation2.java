...
@Generated(
    ...
    date = "2021-09-27T22:12:01.920918-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ExclusionGlobalEvaluation2 implements EntryEntity {
  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/Global exclusion of adverse reactions
  ...
  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/Tree/Global exclusion of adverse reactions/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/Extension
  ...
  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: International Patient Summary/Allergies & Intolerances/Exclusion - global/feeder_audit
   */
  @Path("/feeder_audit")
