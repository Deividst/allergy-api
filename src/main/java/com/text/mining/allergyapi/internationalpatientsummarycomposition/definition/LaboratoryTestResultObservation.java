...
@Generated(
    ...
    date = "2021-09-27T22:12:02.011085-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class LaboratoryTestResultObservation implements EntryEntity {
  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/Receiving laboratory
  ...
  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/Testing details
  ...
  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/Extension
  ...
  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: International Patient Summary/Diagnostic Results/Laboratory test result/Any event
