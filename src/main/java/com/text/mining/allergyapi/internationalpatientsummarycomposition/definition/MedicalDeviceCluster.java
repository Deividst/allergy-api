...
@Generated(
    ...
    date = "2021-09-27T22:12:01.991774-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class MedicalDeviceCluster implements LocatableEntity {
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Device name
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Device name/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour deviceNameNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Type
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Type/null_flavour
   */
  @Path("/items[at0003]/null_flavour|defining_code")
  private NullFlavour typeNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Description
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Description/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour descriptionNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Properties
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Unique device identifier (UDI)
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Unique device identifier (UDI)/null_flavour
   */
  @Path("/items[at0021]/null_flavour|defining_code")
  private NullFlavour uniqueDeviceIdentifierUdiNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Manufacturer
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Manufacturer/null_flavour
   */
  @Path("/items[at0004]/null_flavour|defining_code")
  private NullFlavour manufacturerNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Date of manufacture
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Date of manufacture/null_flavour
   */
  @Path("/items[at0005]/null_flavour|defining_code")
  private NullFlavour dateOfManufactureNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Serial number
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Serial number/null_flavour
   */
  @Path("/items[at0020]/null_flavour|defining_code")
  private NullFlavour serialNumberNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Catalogue number
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Catalogue number/null_flavour
   */
  @Path("/items[at0022]/null_flavour|defining_code")
  private NullFlavour catalogueNumberNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Model number
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Model number/null_flavour
   */
  @Path("/items[at0023]/null_flavour|defining_code")
  private NullFlavour modelNumberNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Batch/Lot number
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Batch/Lot number/null_flavour
   */
  @Path("/items[at0006]/null_flavour|defining_code")
  private NullFlavour batchLotNumberNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Software version
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Software version/null_flavour
   */
  @Path("/items[at0025]/null_flavour|defining_code")
  private NullFlavour softwareVersionNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Date of expiry
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Date of expiry/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Asset management
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Components
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Extension
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Multimedia
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Device details/Medical device/Comment
  ...
  /**
   * Path: International Patient Summary/Medical Devices/Device use statement/Tree/Device details/Medical device/Comment/null_flavour
   */
