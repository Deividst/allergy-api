...
@Generated(
    ...
    date = "2021-09-27T22:12:02.286428-03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ProblemDiagnosisEvaluation3 implements EntryEntity {
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Problem/Diagnosis name
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/structure/Problem/Diagnosis name/null_flavour
   */
  @Path("/data[at0001]/items[at0002]/null_flavour|defining_code")
  private NullFlavour problemDiagnosisNameNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Body site
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Structured body site
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Date/time of onset
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/structure/Date/time of onset/null_flavour
   */
  @Path("/data[at0001]/items[at0077]/null_flavour|defining_code")
  private NullFlavour dateTimeOfOnsetNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/structure/Severity/null_flavour
   */
  @Path("/data[at0001]/items[at0005]/null_flavour|defining_code")
  private NullFlavour severityNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Specific details
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Date of abatement
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/structure/Date of abatement/null_flavour
   */
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Problem/Diagnosis qualifier
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/structure/Diagnostic certainty/null_flavour
   */
  @Path("/data[at0001]/items[at0073]/null_flavour|defining_code")
  private NullFlavour diagnosticCertaintyNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Last updated
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Tree/Last updated/null_flavour
   */
  @Path("/protocol[at0032]/items[at0070]/null_flavour|defining_code")
  private NullFlavour lastUpdatedNullFlavourDefiningCode;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Extension
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Diagnostic certainty
  ...
  /**
   * Path: International Patient Summary/Functional Status/Problem/Diagnosis/Severity
